...
boxplot(box_data.val[1])

boxplot(reduce(vcat,box_data.cat),reduce(vcat,box_data.val))

reduce(vcat,box_data.cat)
reduce(vcat,box_data.val)
...
ylims!(60,120)
boxplot!(fill(1,67),mean(fut_hist,dims=1)[:],color=bcols[1])
boxplot!(fill(2,67),mean(fut_nf_rcp45,dims=1)[:],color=bcols[2])
boxplot!(fill(3,67),mean(fut_nf_rcp85,dims=1)[:],color=bcols[3])
boxplot!(fill(4,67),mean(fut_ff_rcp45,dims=1)[:],color=darken(bcols[2],0.8))
boxplot!(fill(5,67),mean(fut_ff_rcp85,dims=1)[:],color=darken(bcols[3],0.8))
text!(0.7,115,text= "a)",align=(:left,:top),fontsize=20)
...
ylims!(60,120)
boxplot!(fill(1,67),mean(fut_hist[mam_cesm_sub,:],dims=1)[:],color=bcols[1])
boxplot!(fill(2,67),mean(fut_nf_rcp45[mam_cesm_sub,:],dims=1)[:],color=bcols[2])
boxplot!(fill(3,67),mean(fut_nf_rcp85[mam_cesm_sub,:],dims=1)[:],color=bcols[3])
boxplot!(fill(4,67),mean(fut_ff_rcp45[mam_cesm_sub,:],dims=1)[:],color=darken(bcols[2],0.8))
boxplot!(fill(5,67),mean(fut_ff_rcp85[mam_cesm_sub,:],dims=1)[:],color=darken(bcols[3],0.8))
text!(0.7,115,text= "b)",align=(:left,:top),fontsize=20)
text!(5.3,115,text= "MAM",align=(:right,:top),fontsize=20)
...
ylims!(60,120)
boxplot!(fill(1,67),mean(fut_hist[jja_cesm_sub,:],dims=1)[:],color=bcols[1])
boxplot!(fill(2,67),mean(fut_nf_rcp45[jja_cesm_sub,:],dims=1)[:],color=bcols[2])
boxplot!(fill(3,67),mean(fut_nf_rcp85[jja_cesm_sub,:],dims=1)[:],color=bcols[3])
boxplot!(fill(4,67),mean(fut_ff_rcp45[jja_cesm_sub,:],dims=1)[:],color=darken(bcols[2],0.8))
boxplot!(fill(5,67),mean(fut_ff_rcp85[jja_cesm_sub,:],dims=1)[:],color=darken(bcols[3],0.8))
text!(0.7,115,text= "c)",align=(:left,:top),fontsize=20)
text!(5.3,115,text= "JJA",align=(:right,:top),fontsize=20)


fig1

save("/home/cschmidt/projects/attaino3/plots/boxplots/fig6_box_hist_future_comp.svg",fig1)
