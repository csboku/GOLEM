...
setwd("/home/cschmidt/projects/attaino3/repos/attain_paper/code/model_comp_final")
...
camx_files <- list.files("../creat_camx_nc/data",pattern = ".nc")
camx_f <- list.files("../creat_camx_nc/data",pattern = ".nc",full.names = TRUE)
